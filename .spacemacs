...
you should place your code here."
  ...
  (global-set-key (kbd "C-x C-l") 'projectile-find-file)
  ...
  (define-key helm-gtags-mode-map (kbd "C-M-j") 'helm-gtags-select)
  ...
  (setq org-default-notes-file "~/Dropbox/org_files/index.org")
  (setq org-refile-targets '((org-agenda-files . (:maxlevel . 6))))
  (setq langtool-default-language "en-UK")

  ;; Adjustment for C-style to Linux Kernel format
  ...
  (defun my-c-mode-common-hook ()
    ...
    (setq tab-stop-list '(8 16 24 32 40 48 56 64 72))
    (setq tab-width 8)
  ...
  ;; Compile Target for Nordic projects
  (setq-default helm-make-build-dir "pca10056/s140/armgcc")
